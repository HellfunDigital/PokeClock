function updateClock() {
  ...
  document.getElementById('hour').innerHTML = `${hours}:${minutes}:${seconds} ${timeSuffix}`;
...
async function updatePokemon() {
  try {
    ...
    document.getElementById('pokemon-name').innerHTML = pokemonName.charAt(0).toUpperCase() + pokemonName.slice(1);
...
document.getElementById('pokemon-sprite').src = 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/items/poke-ball.png';
